...
def irt(data, train_matrix, zero_train_matrix, val_data, lr, iterations, alpha, lambd, q_meta):
    ...
    train_accs, val_accs = [], []
    final_theta, final_beta, final_alpha, final_c, final_k = theta, beta, alpha, c, k
    max_acc = 0
    ...
    for i in range(iterations):
        ...
        # return final parameters with max validation accuracy during iteration
        if val_acc > max_acc:
    ...
    return final_theta, final_beta, final_alpha, final_c, final_k
